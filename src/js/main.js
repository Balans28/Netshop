...
//------------
    ...
    $('.catalog__caption').on('click', 'li:not(.catalog__item-active)', function () {
        ...
        let ulIndex = $('ul.catalog__caption').index($(this).parents('ul.catalog__caption'));
...
//переходы
    ...
    DG.then(function () {
        ...
        let myIcon = DG.icon({
            iconUrl: 'https://static.tildacdn.com/tild3630-3830-4465-a464-626163386265/c1.png',
            iconRetinaUrl: 'my-icon@2x.png',
            iconSize: [50, 50],
        });
        let marker = DG.marker([42.843731, 74.623135], {icon: myIcon}).addTo(map).bindPopup('Вы кликнули по локации!');
        marker.bindLabel('IT-RUN Academy-Учебный Центр', {static: true});
    });
